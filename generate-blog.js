...
const footer = `<footer><div class="footer-bottom"><span>© ${new Date().getFullYear()} The Find List</span><span>Thoughtful finds for everyday life.</span></div></footer></body></html>`;
